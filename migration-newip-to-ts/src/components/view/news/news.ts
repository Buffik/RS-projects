...
class News {
  draw(data: NewsItem[]) {
    ...
    const newsItemTemp: HTMLTemplateElement | null = queryElement(
      document,
      HTMLTemplateElement,
      '#newsItemTemp'
    );
    ...
    news.forEach((item, idx) => {
      ...
      const newsMetaPhoto = queryElement(
        newsClone,
        HTMLDivElement,
        '.news__meta-photo'
      );
      ...
      const newsMetaAuthor = queryElement(
        newsClone,
        HTMLLIElement,
        '.news__meta-author'
      );
      ...
      const newsMetaDate = queryElement(
        newsClone,
        HTMLLIElement,
        '.news__meta-date'
      );
      ...
      const newsDescriptionTitle = queryElement(
        newsClone,
        HTMLHeadingElement,
      ...
      const newsDescriptionSource = queryElement(
        newsClone,
        HTMLHeadingElement,
      ...
      const newsDescriptionContent = queryElement(
        newsClone,
      ...
      const newsReadMoreLink = queryElement(
        newsClone,
        HTMLAnchorElement,
        '.news__read-more a'
      );
